...
# import data
zwe_ae <- read_csv("zwe_agroecology_format.csv",show_col_types = FALSE)
zwe_cn <- read_csv("zwe_context_format.csv",show_col_types = FALSE)
zwe_pf <- read_csv("zwe_performance_format.csv",show_col_types = FALSE)
